...
public class PropertyManager {
	...
	public static PropertyManager getInstance() {
		if (pm == null) pm = new PropertyManager();
		return pm;
	}
	...
	private void loadProperties(String filename) {
		...
		try {
			...
			try { in.close(); } catch(IOException ex2) { /* ignore it */ }
		}
	 ...
	 * @param propName
	 * @return the vlaue of the property or empty string if not found
	 */
...
//		
//		// read and print some properties
//		System.out.printf("%s = %s\n", "database.user", pm.getProperty("database.user"));
//		System.out.printf("%s = %s\n", "database.url", pm.getProperty("database.url"));
//	
//		System.out.println();
